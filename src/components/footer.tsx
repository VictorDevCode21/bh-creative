...
function Footer() {
    return (
        <footer id='contact' className="w-full h-60 flex md:pt-10 xs:pt-0 xs:pl-4 xs:pr-4 md:pr-0 md:pl-0 dark:text-light">
                ...
                <div className="md:w-full xs:w-full  md:h-full xs:h-28 flex  justify-between md:pl-10 md:pr-10 lg:pb-2">
                    <div className='xs:pl-1 xs:pr-1 md:pr-0 md:pl-0'>
                        <Link href="https://www.instagram.com/bh.creativeusa/">
                            <button className="p-2 shadow-md shadow-gray-400 rounded-full dark:shadow-light">
                                <FaInstagram size={20} />
                            </button>
                        </Link>
                    </div>
