...
function HeaderMobile() {
    return (
        <header id="homem" className="w-full h-screen flex bg-cover bg-center xs:flex lg:hidden rounded-br-3xl relative" style={{ backgroundImage: 'url(/images/profile-photo2.jpg)' }}>
            <div className="w-full h-full flex flex-col items-start justify-center">
                ...
                <div className="absolute bottom-24 right-5">
                    <button className="p-2 rounded-full text-white bg-cyan-400"><AiFillCaretLeft size={15} /></button>
                </div>
                <div className="absolute bottom-12 right-5">
                    <button className="p-2 rounded-full text-white bg-cyan-400"><AiFillCaretRight size={15} /></button>
                </div>
            </div>
        </header>
    )
