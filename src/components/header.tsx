        ...
        <header id="home" className="w-full h-screen lg:flex xs:hidden">
            <div className="w-1/2 h-full relative z-50">
                <Image className="w-full h-full rounded-br-3xl"
                    ...
                    height={1080}
                />
                <h1 className="absolute top-56 left-3/4 pl-10 text-6xl text-cyan-400">BH CREATIVE</h1>
            ...
            <div className="w-1/2 flex flex-col justify-center ">
                ...
                <div className="pl-6 ">
                    <button className="px-4 rounded-md bg-cyan-500 font-semibold text-white text-base">Contáctanos</button>
                </div>
            </div>
        </header>
    )
