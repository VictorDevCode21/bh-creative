        ...
        <section id="projects" className='w-full h-full lg:flex flex-col '>
            ...
            <div className='lg:w-full lg:h-96 flex pb-6 xs:w-full xs:h-96 xs:flex-col lg:flex-row xs:pl-4 xs:pr-4'>
                ...
                <div className='lg:w-1/2 lg:h-full lg:pr-28 lg:pl-10 xs:w-full xs:h-1/2 flex flex-col justify-center items-center '>
                    ...
                    <p className=" xs:text-sm lg:text-lg">Este portafolio fue creado con el fin de mostrar desarrollos web de uno de nuestros programadores.
                        En el mismo figuran sus proyectos más recientes, así como sus datos de contacto.
                    </p>
                    <p className="pt-2 xs:text-sm lg:text-lg">Teck Stack: #Nextjs, #Typescript, #Postgresql, #Tailwindcss, #Prisma, #AWS</p>
                </div>
            </div>
            <div className='lg:w-full lg:h-96 xs:w-full xs:h-96 xs:flex-col lg:flex-row-reverse flex flex-row-reverse pb-6 xs:pl-4 xs:pr-4'>
                ...
                <div className='lg:w-1/2 lg:h-full lg:pl-28 lg:pr-6 xs:w-full xs:h-1/2 flex flex-col justify-center lg:items-start xs:items-center  '>
                    ...
                    <div className="flex flex-col items-start">
                        <p className="pt-2 lg:text-lg xs:text-sm">Este sitio web lo realizamos para un negocio que realiza trabajos de mantenimiento
                            de pisos en la ciudad de Caracas, Venezuela.
                        </p>
                        <p className="pt-2 lg:text-lg xs:text-sm ">Teck Stack: #Nextjs, #Typescript, #Tailwindcss, #DigitalOcean</p>
                    </div>
                </div>
            </div>
        </section>
